...
public class CircleChartPercentage extends CircleChart {
    ...
    private void refreshChart() {
        ...
        controller.setFractionLabel((int)amount, (int)total);
        if(total != 0) controller.setPercentageLabel(amount/total*100);
        else controller.setPercentageLabel(-1);
    }
    ...
    private void initialize() {
        ...
        controller.gradeLabel.setMaxHeight(0);
